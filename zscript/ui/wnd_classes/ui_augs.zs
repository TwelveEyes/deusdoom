class UI_Augs : UI_Window
{
	...
	override void drawOverlay(RenderEvent e)
	{
		...
		UI_Draw.str(aug_font_bold, "Augmentations", 11, x + 4.6, y + 1.8, -0.4, -0.4);

		UI_Draw.str(aug_font, "Cranial", 11, x + 25, y + 12, -0.45, -0.45);
			UI_Draw.texture(body_cranial, x + 60.3, y + 19, 0, 9);
		UI_Draw.str(aug_font, "Eyes", 11, x + 90.5, y + 12, -0.45, -0.45);
			UI_Draw.texture(body_eyes, x + 67.5, y + 26.5, 0, 5);
		UI_Draw.str(aug_font, "Arms", 11, x + 9, y + 44, -0.45, -0.45);
			UI_Draw.texture(body_arms, x + 44, y + 46, 0, 19);
		UI_Draw.str(aug_font, "Torso", 11, x + 104.5, y + 46.6, -0.45, -0.45);
			UI_Draw.texture(body_torso, x + 66, y + 45.5, 0, 20);
		UI_Draw.str(aug_font, "Subdermal", 11, x + 9, y + 79.5, -0.45, -0.45);
			UI_Draw.texture(body_subdermal, x + 35.5, y + 67, 0, 15.5);
		UI_Draw.str(aug_font, "Legs", 11, x + 104.5, y + 131.5, -0.45, -0.45);
			UI_Draw.texture(body_legs, x + 69, y + 93, 0, 40);
		UI_Draw.str(aug_font, "Unclassified", 11, x + 8.5, y + 139.5, -0.45, -0.45);
